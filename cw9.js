...
//     let mounthduratiobelement=document.createElement('div')
//     mounthduratiobelement.innerText=`${coursesArrayElement.monthDuration}`
//     let hourdurationelement=document.createElement('div')
//     hourdurationelement.innerText=`${coursesArrayElement.hourDuration}`
//     let moduleselemet=document.createElement('ul')
//     for (const moduleselemetElement of moduleselemet) {
//         let mod=document.createElement('li')
//         mod.innerText=moduleselemetElement
//         moduleselemet.appendChild(mod)
//     }
// course.appendChild(titleelement)
//     course.appendChild(mounthduratiobelement)
//     course.appendChild(hourdurationelement)
//     course.appendChild(moduleselemet)
